...
export default function FeaturedPost() {
  return (
    ...
    >
      ...
      <a href="#" className="group block max-w-7xl mx-auto px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center rounded-lg overflow-hidden bg-[#1a1715] border border-[#f3eee4]/10">
          {/* image */}
          <div className="relative h-[220px] sm:h-[300px] md:h-[380px] overflow-hidden">
            ...
            />
            <span className="absolute top-4 left-4 font-mono text-[10px] tracking-[0.1em] uppercase text-[#0e0d0c] bg-[#f2b705] rounded-full px-3 py-1">
              Featured
            </span>
          </div>
          ...
          <div className="p-6 sm:p-8 md:p-0 md:pr-10">
            <span className="font-mono text-[11px] tracking-[0.1em] uppercase text-[#f2b705]">
              Client Work
            </span>
            ...
            <div className="flex items-center gap-3 font-mono text-[11px] tracking-wide uppercase text-[#6b6459] mb-6">
            ...
            <span className="inline-flex items-center gap-2 font-mono text-[12px] tracking-wide uppercase text-[#f3eee4] border-b border-[#f3eee4]/30 pb-1 group-hover:border-[#f2b705] group-hover:text-[#f2b705] transition-colors">
              Read the story
